...
{
	double (*trufuncPr)(gsl_vector *, void *);// fitfunc
	void *trufuncParam;                       // params
};


// function for local minimizer 
double dummyfitfunc(const gsl_vector *, void *);



// function for pso
void ptapso_omp(size_t, double (*)(gsl_vector *, void *),void *,struct psoParamStruct *,struct returnData * );
//size_t, /* Dimensionality of fitness function */
